...
use App\Modules\Audit\Application\GetSecurityLogsAction;
...
class SecurityLogController extends Controller
{
    ...
    // GET /api/v1/security-logs — Owner, Admin only (EnsureOwnerOrAdminRole, route-level)
    public function index(Request $request, GetSecurityLogsAction $action): AuditLogCollection
    {
        $logs = $action->handle(
